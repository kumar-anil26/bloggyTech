                ...
                <div className="border rounded-lg shadow-sm">
                  ...
                  <div className="p-3">
                    <textarea
                      id="comment"
                      rows={3}
                      className="text-cyan-950 block w-full mt-1 border-gray-300 rounded-md shadow-sm form-textarea focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
