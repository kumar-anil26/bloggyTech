  ...
  async (payload, { rejectWithValue }) => {
    ...
    try {
      const { data } = await axios.get(
        "https://bloggy-tech.vercel.app/api/v1/posts/public"
      );
      return data;
    } catch (error) {
...
export const PostsListAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        "https://bloggy-tech.vercel.app/api/v1/posts",
        config
      );
      return data;
    } catch (error) {
...
export const getPostAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    ...
    try {
      const { data } = await axios.get(
        `https://bloggy-tech.vercel.app/api/v1/posts/${payload}`
      );
      return data;
    } catch (error) {
      return rejectWithValue(error?.response?.data);
  ...
  async (payload, { rejectWithValue, getState }) => {
    try {
      ...
      const { data } = await axios.put(
        `https://bloggy-tech.vercel.app/api/v1/posts/${payload.id}`,
        payload.formData,
        config
      );
      return data;
...
export const likesPostAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://bloggy-tech.vercel.app/api/v1/posts/like/${payload}`,
        {},
        config
      );
...
export const disLikesPostAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://bloggy-tech.vercel.app/api/v1/posts/dislike/${payload}`,
        {},
        config
      );
...
export const viewsPostAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://bloggy-tech.vercel.app/api/v1/posts/views/${payload}`,
        {},
        config
      );
...
export const clapsPostAction = createAsyncThunk(
  ...
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://bloggy-tech.vercel.app/api/v1/posts/claps/${payload}`,
        {},
        config
      );
